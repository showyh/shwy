...
EspectroAudible.prototype = Object.assign(Object.create(ObjetoCanvas.prototype), {
    ...
    Iniciar: function () {
        ...
        // Creo el suelo 
        this.Suelo = new THREE.Mesh(new THREE.BoxGeometry(160, 40, 130), new THREE.MeshPhongMaterial({
        ...
        this.SueloAnalizador = new THREE.Mesh(new THREE.BoxGeometry(32, 0.6, 32), new THREE.MeshPhongMaterial({
            color: this.Colores.Suelo,
            specular: 0xeeeeee
        }));
        ...
        this.Controles = new THREE.Mesh(Geo, new THREE.MeshPhongMaterial({
            color: this.Colores.Suelo,
            specular: 0xeeeeee
        }));
        ...
        this.C_Atras = new THREE.Mesh(new THREE.BoxGeometry(3, 1, 3), new THREE.MeshPhongMaterial({
            color: this.Colores.Controles,
            specular: 0xeeeeee
        }));
        this.C_Atras.position.set(-4, 0.2, -2.5);
        this.Controles.add(this.C_Atras);
        this.C_Play = new THREE.Mesh(new THREE.BoxGeometry(3, 1, 3), new THREE.MeshPhongMaterial({
            color: this.Colores.Controles,
            specular: 0xeeeeee
        }));
        this.C_Play.position.set(-0, 0.2, -2.5);
        this.Controles.add(this.C_Play);
        this.C_Adelante = new THREE.Mesh(new THREE.BoxGeometry(3, 1, 3), new THREE.MeshPhongMaterial({
            color: this.Colores.Controles,
            specular: 0xeeeeee
        }));
        ...
        this.C_BarraTiempo = new THREE.Mesh(new THREE.BoxGeometry(this.AnchoBarraTiempo, 1, 1), new THREE.MeshPhongMaterial({
            color: this.Colores.Controles,
            specular: 0xeeeeee
        }));
        this.C_BarraTiempo.position.set(0, 0.2, -6);
        this.Controles.add(this.C_BarraTiempo);
        this.C_SliderTiempo = new THREE.Mesh(new THREE.BoxGeometry(4, 1.2, 2.2), new THREE.MeshPhongMaterial({
            color: this.Colores.Controles,
            specular: 0xeeeeee
        }));
